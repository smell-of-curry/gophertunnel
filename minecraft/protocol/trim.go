...
// TrimPattern represents a pattern that can be applied to an armour pice in combination with a TrimMaterial.
...
type TrimMaterial struct {
	...
	MaterialID string
	// Color is the color code used for text formatting, for example '§j'.
	Color string
